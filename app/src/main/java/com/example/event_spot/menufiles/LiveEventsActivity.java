...
//        View wizard=getLayoutInflater().inflate(R.layout.activity_live_events,null);
//        dynamicContent.addView(wizard);
        ...
        if (dynamicContent != null) { // Check if dynamicContent is not null
            ...
            Log.e("LiveEventsActivity", "dynamicContent is null");
        }

        RadioGroup rg=findViewById(R.id.radioGroup1);
        RadioButton rb=findViewById(R.id.buttonLiveEvent);
