...
public class UserProfileActivity extends BaseActivity {
    ...
    LinearLayout bottomNavBar,dynamicContent;
...
//        View wizard=getLayoutInflater().inflate(R.layout.activity_user_profile,null);
//        dynamicContent.addView(wizard);
        ...
        if (dynamicContent != null) { // Check if dynamicContent is not null
            ...
            Log.e("UserProfileActivity", "dynamicContent is null");
        }

        RadioGroup rg=findViewById(R.id.radioGroup1);
        RadioButton rb=findViewById(R.id.buttonProfile);
